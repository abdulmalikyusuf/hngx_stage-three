...
// import Neom from "@/assets/images/neom-JZerhwPHiBI-unsplash.jpg";
// import Neom1 from "@/assets/images/neom-kXbit_yx8t4-unsplash.jpg";
// import Neom2 from "@/assets/images/neom-wbOKjgQv3nY-unsplash.jpg";
...
const layout = [
	...
	{ i: "three", x: 2, y: 0, w: 1, h: 1 },
	{ i: "four", x: 3, y: 0, w: 1, h: 1 },
	{ i: "five", x: 0, y: 1, w: 1, h: 1 },
	{ i: "six", x: 1, y: 1, w: 1, h: 1 },
	{ i: "seven", x: 2, y: 1, w: 1, h: 1 },
	{ i: "eight", x: 3, y: 1, w: 1, h: 1 },
];
...
function ImageGrid({ data }: { data: Basic[] }) {
	return (
					...
					<div className="relative flex">
						<div>
							<LazyLoadImage
								...
								// height={photo.height}
								src={photo.urls.full} // use normal <img> attributes as props
								// width={photo.width}
							/>
